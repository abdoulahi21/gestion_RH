        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            ...
            <div>
                <a class="navbar-brand brand-logo" href="index.html">
                    <img src="{{asset('images/logo1.png')}}" alt="logo" style="height: 100px;"/>
                </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @endcanany
                            @canany(['manage-leave','view-conge'])
                                <li class="nav-item"><a class="nav-link" href="{{route('conge.index')}}">Conges</a></li>
                            @endcanany
                            @canany(['manage-absences','view-absences'])
                                <li class="nav-item"><a class="nav-link" href="{{route('absence.index')}}">Absences</a></li>
                            @endcanany
                        </ul>
                    </div>
                </li>
